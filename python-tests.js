...
['tuple as dict key','d={}\nd[(1,2)]="a"\nprint(d[(1,2)], d.get((1,2)), (1,2) in d)','a a True'],
['tuple keys hash by value','d={}\nd[(1,2)]=1\nd[(1,2)]=2\nprint(len(d), d[(1,2)])','1 2'],
['distinct tuple keys','d={}\nd[(0,0)]="a"\nd[(0,1)]="b"\nprint(len(d), d[(0,0)], d[(0,1)])','2 a b'],
['keys come back as tuples','d={}\nd[(3,4)]=1\nprint(list(d.keys()))','[(3, 4)]'],
['dict of positions','d={}\nfor y in range(2):\n    for x in range(2):\n        d[(x,y)]=x+y\nprint(len(d), d[(1,1)], sorted(d.values()))','4 2 [0, 1, 1, 2]'],
['mixed key types','d={}\nd[1]="i"\nd["1"]="s"\nd[(1,)]="t"\nprint(len(d), d[1], d["1"], d[(1,)])','3 i s t'],
['dict copy is independent','a={}\na[(1,2)]=1\nb=a.copy()\nb[(1,2)]=9\nprint(a[(1,2)], b[(1,2)])','1 9'],
['pop by tuple key','d={}\nd[(1,2)]=7\nprint(d.pop((1,2)), len(d))','7 0'],
